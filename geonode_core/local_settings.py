...
GEOSERVER_LOCATION = os.getenv(
    'GEOSERVER_LOCATION', 'http://www.atlas.alpconv.org/geoserver/'
)
...
DEFAULT_MAP_CENTER = (os.environ.get('DEFAULT_MAP_CENTER_X', 10), os.environ.get('DEFAULT_MAP_CENTER_Y',46))


# How tightly zoomed should newly created maps be?
# 0 = entire world;
# maximum zoom is between 12 and 15 (for Google Maps, coverage varies by area)
DEFAULT_MAP_ZOOM = int(os.environ.get('DEFAULT_MAP_ZOOM', 7))
...
#search page result list limit
CLIENT_RESULTS_LIMIT = 20

#AC atlas custom setting
...
AUTO_ASSIGN_REGISTERED_MEMBERS_TO_REGISTERED_MEMBERS_GROUP_AT = 'registration'

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'alpine.convention.atlas@gmail.com'
EMAIL_HOST_PASSWORD = ''
EMAIL_PORT = 587
EMAIL_USE_TLS = True


ALLOWED_HOSTS = ['127.0.0.1', 'localhost','www.atlas.alpconv.org','193.106.181.171']
PROXY_ALLOWED_HOSTS = ['127.0.0.1', 'localhost','www.atlas.alpconv.org','193.106.181.171']
